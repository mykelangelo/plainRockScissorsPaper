...
/*func (c Chat) ChatConfig() ChatConfig { todo fix or delete
...
type Message struct {
	...
	//PassportData          *PassportData      `json:"passport_data,omitempty"` // optional todo fix or delete
}
...
/*func (f *File) Link(token string) string { todo fix or delete
